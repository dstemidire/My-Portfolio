        ...
        (function (e) {
            ...
            function y(e) {
                (v = a.window.innerWidth || document.documentElement.clientWidth),
                    (b = l
                        ? (!m && document.body && (((m = document.createElement("div")).style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;"), document.body.appendChild(m)),
                          (m ? m.clientHeight : 0) || a.window.innerHeight || document.documentElement.clientHeight)
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e = this,
                                    ...
                                    l = 0;
                                return (
                                    o && (i < 0 ? ((a = i * Math.max(n, b)), b < n && (a -= i * (n - b))) : (a = i * (n + b)), 1 < i ? (r = Math.abs(a - b)) : i < 0 ? (r = a / i + Math.abs(a)) : (r += (b - n) * (1 - i)), (a /= 2)),
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                var t = this,
                                    ...
                                    r = n;
                                if (
                                    (t.options.elementInViewport && (r = t.options.elementInViewport.getBoundingClientRect()), (t.isElementInViewport = 0 <= r.bottom && 0 <= r.right && r.top <= b && r.left <= v), e || t.isElementInViewport)
                                ) {
                                    var l = Math.max(0, i),
                                        s = Math.max(0, o + i),
                                        c = Math.max(0, -i),
                                    ...
                                    t.css(t.image.$item, a),
                                        t.options.onScroll &&
                                            t.options.onScroll.call(t, { section: n, beforeTop: l, beforeTopEnd: s, afterTop: c, beforeBottom: u, beforeBottomEnd: d, afterBottom: m, visiblePercent: f, fromViewportCenter: p });
                                }
                            },
                        },
                        {
            ...
            function E(e, t) {
                ("object" === ("undefined" == typeof HTMLElement ? "undefined" : c(HTMLElement))
                    ...
                    : e && "object" === (void 0 === e ? "undefined" : c(e)) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName) && (e = [e]);
    ...
    function (module, exports, __webpack_require__) {
        ...
        var VideoWorker = (function () {
            function VideoWorker(url, options) {
                ...
                var self = this;
                self.url = url;
                self.options_default = { autoplay: false, loop: false, mute: false, volume: 100, showContols: true, startTime: 0, endTime: 0 };
                    ...
                    value: function getVideo(callback) {
                        ...
                        self.onAPIready(function () {
                            ...
                            if (self.type === "youtube") {
                                ...
                                self.playerOptions.playerVars = { autohide: 1, rel: 0, autoplay: 0, playsinline: 1 };
                            ...
                            if (self.type === "vimeo") {
                                self.playerOptions = { id: self.videoID, autopause: 0, transparent: 0, autoplay: self.options.autoplay ? 1 : 0, loop: self.options.loop ? 1 : 0, muted: self.options.mute ? 1 : 0 };
            ...
            Jarallax.prototype.init = function () {
                ...
                if (self.video && !self.options.disableVideo()) {
                    self.video.getVideo(function (video) {
                        ...
                        self.css(video, { position: self.image.position, top: "0px", left: "0px", right: "0px", bottom: "0px", width: "100%", height: "100%", maxWidth: "none", maxHeight: "none", margin: 0, zIndex: -1 });
                        self.$video = video;
                    ...
                    if (!defaultResult) {
                        if (!self.defaultInitImgResult) {
                            video.getImageURL(function (url) {
                                ...
                                self.css(self.$item, { "background-image": 'url("' + url + '")', "background-position": "center", "background-size": "cover" });
                            });
                        }
                    } else {
                ...
                Jarallax.prototype[key] = function () {
                    ...
                    switch (key) {
                        ...
                        case "onResize":
                            ...
                            self.itemData = { width: rect.width, height: rect.height, y: rect.top + self.getWindowData().y, x: rect.left };
...
(function (global, factory) {
    ...
    var Virtual$1 = {
        name: "virtual",
        params: { virtual: { enabled: false, slides: [], cache: true, renderSlide: null, renderExternal: null, addSlidesBefore: 0, addSlidesAfter: 0 } },
        create: function create() {
            var swiper = this;
            Utils.extend(swiper, {
                virtual: {
    ...
    var Autoplay$1 = {
        name: "autoplay",
        params: { autoplay: { enabled: false, delay: 3e3, waitForTransition: true, disableOnInteraction: true, stopOnLastSlide: false, reverseDirection: false } },
        create: function create() {
            var swiper = this;
            Utils.extend(swiper, {
                autoplay: {
    ...
    var Thumbs = {
        init: function init() {
            ...
            if (thumbsParams.swiper instanceof SwiperClass) {
                ...
                swiper.thumbs.swiper = new SwiperClass(Utils.extend({}, thumbsParams.swiper, { watchSlidesVisibility: true, watchSlidesProgress: true, slideToClickedSlide: false }));
    ...
    var Thumbs$1 = {
        ...
        create: function create() {
            var swiper = this;
            Utils.extend(swiper, { thumbs: { swiper: null, init: Thumbs.init.bind(swiper), update: Thumbs.update.bind(swiper), onThumbClick: Thumbs.onThumbClick.bind(swiper) } });
        },
        on: {
            beforeInit: function beforeInit() {
                var swiper = this;
...
(function (window, doc) {
    ...
    function grained(ele, opt) {
        ...
        var options = { animate: true, patternWidth: 100, patternHeight: 100, grainOpacity: 0.1, grainDensity: 1, grainWidth: 1, grainHeight: 1, grainChaos: 0.5, grainSpeed: 20 };
...
!(function (n) {
        ...
        n(window).on("load", function () {
            ...
            e.find(".spinner").fadeOut(function () {
                ...
                n(".typed-subtitle").length &&
                    ...
                    n(".typed-subtitle").each(function () {
                        n(this).typed({ stringsElement: n(this).prev(".typing-subtitle"), loop: !0 });
                    }),
                setTimeout(function () {
                    n(".h-subtitles").addClass("ready"), n(".typed-bread").length && n(".typed-bread").typed({ stringsElement: n(".typing-bread"), showCursor: !1 });
                }, 1e3);
            var a = location.hash,
                t = n(a);
            if ((0 == a.indexOf("#section-") && t.length && n("body, html").animate({ scrollTop: n(a).offset().top - 68 }, 400), n(".jarallax").length && n(".jarallax").jarallax(), n(".started-carousel").length)) {
                var i = new Swiper(".started-carousel .swiper-container", {
                    ...
                    slidesPerView: 1,
                    simulateTouch: !1,
                    autoplay: { delay: 6e3, disableOnInteraction: !1, waitForTransition: !1 },
                    navigation: { nextEl: ".started .swiper-button-next", prevEl: ".started .swiper-button-prev" },
                });
                i.on("slideChange", function () {
                    ...
                    n(".started-carousel .swiper-slide").removeClass("first"),
                        n(".started-carousel .swiper-slide").each(function (e, a) {
                            e <= t - 1 ? n(a).addClass("swiper-clip-active") : n(a).removeClass("swiper-clip-active");
                        }),
                        n(".started-carousel .swiper-slide").each(function (e, a) {
                            n(a).css({ "z-index": s - e });
                        });
            ...
            if (n(".reviews-carousel").length)
                new Swiper(".reviews-carousel .swiper-container", {
                    ...
                    slidesPerView: 2,
                    autoplay: { delay: 6e3 },
                    navigation: { nextEl: ".reviews-carousel .swiper-button-next", prevEl: ".reviews-carousel .swiper-button-prev" },
                    breakpoints: { 720: { slidesPerView: 1, spaceBetween: 40 }, 1200: { slidesPerView: 2, spaceBetween: 70 } },
                });
            setTimeout(function () {
    ...
    if (
        ...
        e < 783 && (n(".section.started").css({ height: a }), n(".logged-in .section.started").css({ height: a - 46 })),
        !n(".grained-off").length)
    ) {
        grained("#grained_container", { animate: !0, patternWidth: 400, patternHeight: 400, grainOpacity: 0.15, grainDensity: 3, grainWidth: 1, grainHeight: 1 });
    }
    1199 < e &&
        (n(document).on("mousemove", function (e) {
            var a = e.pageX,
                t = e.pageY;
            n(".cursor-follower").css("transform", "translate3d(" + a + "px," + t + "px,0px)");
        }),
        n("a, .btn-group").on({
            mouseenter: function (e) {
                n(".cursor-follower").stop().animate({ width: 86, height: 86, opacity: 0.1, margin: "-43px 0 0 -43px" }, 500);
            },
            mouseleave: function (e) {
                n(".cursor-follower").stop().animate({ width: 26, height: 26, opacity: 0.4, margin: "-13px 0 0 -13px" }, 500);
            },
        })),
        n(".hover-masks a").each(function () {
            var e = n(this).html();
            n(this).wrapInner('<span class="mask-lnk"></span>'), n(this).append('<span class="mask-lnk mask-lnk-hover">' + e + "</span>");
        }),
        n(".hover-animated .circle").on({
            mouseenter: function (e) {
                0 === n(this).find(".ink").length && n(this).prepend("<span class='ink'></span>");
                ...
                a.css({ top: i + "px", left: s + "px" }).addClass("ink-animate"), n(".cursor-follower").addClass("hide");
            },
            mouseleave: function (e) {
                var a = n(this).find(".ink"),
                    t = e.pageX - n(this).offset().left - a.width() / 2,
                    s = e.pageY - n(this).offset().top - a.height() / 2;
                a.css({ top: s + "px", left: t + "px" }).removeClass("ink-animate"), n(".cursor-follower").removeClass("hide");
            },
        }),
        n("header .top-menu, .typed-bread, .popup-box .bts, .animate-to-page").on("click", "a", function () {
            var e = n(this).attr("href");
            return (
                0 == e.indexOf("#section-")
                    ? (n("body").hasClass("home") || (location.href = "/" + e), n("body, html").animate({ scrollTop: n(e).offset().top - 68 }, 400), n("header").hasClass("active") && n(".menu-btn").trigger("click"))
        ...
        n(window).on("scroll", function () {
            n(this).scrollTop() >= n(".section.started").height() ? n("body").removeClass("background-enabled") : !n("header").hasClass("active") && n(".video-bg").length && n("body").addClass("background-enabled"),
                100 <= n(this).scrollTop() && 1 < n(".section").length && (n(".header").addClass("fixed"), n(".footer").addClass("fixed"), n(".mouse_btn").fadeOut()),
                n(this).scrollTop() <= 100 && 1 < n(".section").length && (n(".header").removeClass("fixed"), n(".footer").removeClass("fixed"), n(".mouse_btn").fadeIn());
        }),
        n("header").on("click", ".menu-btn", function () {
            return (
                n("header").hasClass("active")
                    ? (n("header").removeClass("active"), n(".footer .soc").fadeIn(), n("body").addClass("loaded"), n(".video-bg").length && n("body").addClass("background-enabled"))
                    : (n("header").addClass("active"), n(".footer .soc").hide(), n("body").removeClass("loaded"), n("body").removeClass("background-enabled")),
                !1
            );
        }),
    ...
    t.imagesLoaded(function () {
        if ((t.isotope({ percentPosition: !0, itemSelector: ".box-item" }), n(".portfolio-items").length)) {
        ...
        n(".filters").on("click", ".btn-group", function () {
            ...
            t.isotope({ filter: e }), n(".filters .btn-group label").removeClass("glitch-effect"), n(this).find("label").addClass("glitch-effect");
        }),
        /\.(?:jpg|jpeg|gif|png)$/i.test(n(".gallery-item:first a").attr("href")) && n(".gallery-item a").magnificPopup({ gallery: { enabled: !0 }, type: "image", closeBtnInside: !1, mainClass: "mfp-fade" }),
        n(".has-popup-media").magnificPopup({ type: "inline", overflowY: "auto", closeBtnInside: !0, mainClass: "mfp-fade" }),
        n(".has-popup-image").magnificPopup({ type: "image", closeOnContentClick: !0, mainClass: "mfp-fade", image: { verticalFit: !0 } }),
        n(".has-popup-video").magnificPopup({
            disableOn: 700,
            type: "iframe",
            iframe: { patterns: { youtube_short: { index: "youtu.be/", id: "youtu.be/", src: "https://www.youtube.com/embed/%id%?autoplay=1" } } },
            removalDelay: 160,
            preloader: !1,
            fixedContentPos: !1,
            mainClass: "mfp-fade",
        ...
        n(".has-popup-music").magnificPopup({ disableOn: 700, type: "iframe", removalDelay: 160, preloader: !1, fixedContentPos: !1, mainClass: "mfp-fade" }),
        n(".has-popup-gallery").on("click", function () {
            var e = n(this).attr("href");
            return (
                n(e)
                    .magnificPopup({ delegate: "a", type: "image", closeOnContentClick: !1, mainClass: "mfp-fade", removalDelay: 160, fixedContentPos: !1, gallery: { enabled: !0 } })
                    .magnificPopup("open"),
                !1
            );
        });
        ...
        n(".video-bg").length &&
            ...
            i
                ? n(".video-mobile-bg").each(function () {
                      n(this).css("background-image", "url(" + n(this).data("mobile-preview") + ")");
                  })
            ...
            n(window).on("scroll", function () {
                ...
                n(".top-menu ul li a").each(function () {
                    if (0 == n(this).attr("href").indexOf("#section-")) {
                        var e = n(this),
                            a = n(e.attr("href"));
                        a.length && a.offset().top <= t + 70 && (n(".top-menu ul li").removeClass("current-menu-item"), e.closest("li").addClass("current-menu-item")), 0 == t && n(".top-menu ul li").removeClass("current-menu-item");
                    }
                });
            }),
    ...
    o.length && o.append('<div class="slice"><div class="bar"></div><div class="fill"></div></div>'),
        n(window).resize(function () {
            var e = n(window).width(),
                a = n(window).height();
            n(".section.started").css({ height: a }), e < 783 && n(".section.started").css({ height: a });
            var t = n(".skills-list.dotted .progress"),
                s = t.width();
            t.length && t.find(".percentage .da").css({ width: s + 1 });
        }),
        n("#cform").validate({
            rules: { name: { required: !0 }, message: { required: !0 }, email: { required: !0, email: !0 } },
            success: "valid",
            submitHandler: function () {
                n.ajax({
                    ...
                    type: "post",
                    dataType: "json",
                    data: "name=" + n("#cform").find('input[name="name"]').val() + "&email=" + n("#cform").find('input[name="email"]').val() + "&message=" + n("#cform").find('textarea[name="message"]').val(),
                    beforeSend: function () {},
                    complete: function () {},
                    success: function (e) {
